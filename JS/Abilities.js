...
let ObjectArrays = { 
	...
	},
	{
		...
		"materials": ["2 white ", 1],
		"effect": ["Enchanted player does not die as normal. When the player would otherwise die they instead remove a strip and become Frozen for 30 seconds. When the Frozen State is ended the bearer has:", "1. All Wounds removed", "2. All States removed that are removed by Death or Respawning.", "3. All ongoing effects with a timer are expired", "4. All of their equipment is fully repaired", "5. All other enchantments, except those which are Persistent, are removed.", "Additionally Phoenix Tears allows you to wear an extra Enchantment from the Protection School. This extra enchantment is considered Persistent as long as Phoenix Tears is present. The additional Enchantment is not removed once Phoenix Tears is removed."],
	...
	},
	{
		...
		"materials": ["yellow ", 1],
		"effect": ["1. Bearer does not die or respawn as normal.", "2. Bearer is Cursed, Fragile, and Suppressed.", "3. When the bearer would normally die, they instead become Insubstantial, remove all Wounds, and must return to the caster as soon as possible. Insubstantial players may not move more than 10’ from the caster and may not speak. The caster may touch the player and then Incant “Rise and fight again” x10 to end this Insubstantial State so long as no living enemies are within 10’ of the bearer.", "4. If this Enchantment’s Insubstantial is removed from the Bearer in any other manner than outlined in item 3 (or prevented entirely) this Enchantment is removed.", "5. If the caster dies, this Enchantment is removed the next time the bearer returns to the caster.", "6. If the Enchantment is removed, the bearer dies.", "7. For the duration of the Enchantment, the Caster is considered the players respawn.", "8. Dead players may be targeted by Undead Minion and are immediately returned to life with all Wounds removed and the Insubstantial State applied."],
	...
	},
	{
		...
		"school": 3,
		"range": 1,
		"incant": ["\"spell name\" followed by: Out of battle I pause to rest, I take some time to catch my breath. Return to me my fleeting power To aid me in my darkest hour.", "number listed on the ability"],
		"materials": "",
...
Classes : [{
        ...
        "Armour": "None",
        "Shield": 0,
        "Weapons": ["All Melee", "Heavy-Thrown (at lv2)"],
        "Jobtype": 1,
		"Sash": "Grey"
	},{
		"Name": "Scout",
        ...
        "Armour": "None",
        "Shield": 1,
        "Weapons": ["Dagger", "Short", "Long", "Great", "Bows"],
        "Jobtype": 2,
		"Sash": "Brown"
	},{
		"Name": "Healer",
